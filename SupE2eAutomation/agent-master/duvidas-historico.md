...
> Entradas movidas de `duvidas.md` por já estarem resolvidas e sem aviso correspondente ativo em
> `fila-merge/pendentes/` (aviso já está em `fila-merge/concluidos/`, ou não há mais nenhum arquivo
> em `fila-merge/` referenciando o id). Nada foi descartado — conteúdo movido verbatim.
