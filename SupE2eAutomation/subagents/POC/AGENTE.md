...
1. Leia `docs/documentacao.md` INTEIRO antes de começar qualquer tarefa (conhecimento específico
   ...
   módulos, aposentado em 2026-09-17). Catálogo de instabilidade de login/HML (cross-módulo):
   `../geral/docs/documentacao.md`.
...
12. **Status compacto para o Gerente (2026-09-17):** sempre que mudar o estado da sua tarefa (mover
    ...
    concorrente de outro módulo), localize a seção `## POC` (crie se ainda não existir) e substitua
