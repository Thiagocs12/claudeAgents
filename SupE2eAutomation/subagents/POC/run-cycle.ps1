...
$nomeTaskAgendada = "SupE2eAutomation-SubAgent-POC"
...
$contaEfetiva = Adquirir-SlotConta -NomeModulo "SupE2eAutomation/POC" -LogPath (Join-Path $PSScriptRoot "run-log.txt")
if (-not $contaEfetiva) {
