...
# Conta do Claude Code "de casa" do Agent Master (não entra no revezio dos subAgents, mas
# participa da alternância por rate-limit abaixo) — reaproveitada do SupE2eAutomation.
#
