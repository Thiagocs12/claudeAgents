...
> Conteúdo movido verbatim de `documentacao.md` em 2026-09-17 (arquivamento por tamanho — arquivo
> principal tinha passado de ~250 linhas). Ver `documentacao.md` para o resumo compacto do que
> ainda é operacionalmente relevante.
